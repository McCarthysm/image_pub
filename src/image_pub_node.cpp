...
int main(int argc, char** argv)
  {
    ...
    ros::NodeHandle nh;
    cv::FileStorage config("/home/jinhwa/catkin_ws/src/image_pub/data/config.yml", cv::FileStorage::READ);
  ...
  ros::Publisher pub_left = nh.advertise<sensor_msgs::Image>("/stereo/left/image_raw", 1);
  ros::Publisher pub_right = nh.advertise<sensor_msgs::Image>("/stereo/right/image_raw",1);
